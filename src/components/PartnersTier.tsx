...
export const PartnersTier = ({ tier, meta }: PartnersTierProps) => {
  ...
  return (
    <div className="partners__tier" >
      ...
      <div className="partners__tier__title" style={
        {
          color: meta.color,
        }
      }>
      ...
      <div className="partners__tier__partners" style={{
        width: meta.width,
      }}>
        {meta.partners.map((partner) =>
          <a key={partner.name} href={partner.url} target="_blank">
            <img alt={partner.name} src={partner.logo.url} style={
              {
      ...
      <div className="blur__bottom" style={
        {
          backgroundColor: meta.color,
        }
      }></div>
